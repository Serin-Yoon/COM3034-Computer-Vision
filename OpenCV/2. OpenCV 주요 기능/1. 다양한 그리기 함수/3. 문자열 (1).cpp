...
int main() {
    ...
    putText(img, "FONT_HERSHE_SIMPLEX", Point(20, 50), FONT_HERSHEY_SIMPLEX, 1, Scalar(0, 0, 255), 1, LINE_8, false);
    ...
    putText(img, "FONT_HERSHEY_COMPLEX | FONT_ITALIC", Point(20, 450), FONT_HERSHEY_SIMPLEX | FONT_ITALIC, 1, Scalar(255, 0, 0));
